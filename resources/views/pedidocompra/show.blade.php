...
<div class="alert alert-success" role="alert">
    ...
    <p>Por padrão, esta mensagem permanece ativa para você até que seja marcada como lida. Ao fazer isso, você deixa de
...
<div style="background-color: rgb(0, 0, 0);" class="p-2">
    ...
    <div class="row mt-2 mb-2">
        ...
        {{-- {!! Form::text('ped_contaaprovada', $pedido->ped_aprovado, ['class' => 'col-sm-8 form-control', 'maxlength' => '100',
        $variavelReadOnlyNaView]) !!} --}}

<select name="ped_contaaprovada" id="ped_contaaprovada" class="selecionaComInput form-control col-sm-7  js-example-basic-multiple"  {{$variavelDisabledNaView}}>
  ...
  @endforeach
    ...
    <div class="row mt-2 mb-2 ">
        ...
        {!! Form::text('ped_exigaprov', $pedido->ped_exigaprov, ['class' => 'col-sm-7 form-control', 'maxlength' => '100',
        $variavelReadOnlyNaView]) !!}
    ...
    <div class="row mt-2 mb-2 ">
        ...
        {!! Form::text('ped_observacao', $pedido->ped_observacao, ['class' => 'col-sm-7 form-control', 'maxlength' => '80',
    $variavelReadOnlyNaView]) !!}
