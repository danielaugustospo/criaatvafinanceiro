...
@section('content')
    ...
    <a onclick="abreModalDespesas(param = 'notafiscalfornecedor');" class="d-flex justify-content-center" href="#"> <i class="fas fa-sync" ></i>Acessar Outro Período/Conta</a>
...
var dataSource = new kendo.data.DataSource({
        ...
        dataSource.fetch().then(function() {
            ...
            columns: [
                ...
                { field: "vencimento", title: "Data", filterable: true, width: 50, format: "{0:dd/MM/yyyy}", filterable: { cell: { template: betweenFilter}} },
