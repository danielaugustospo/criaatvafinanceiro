...
<a onclick="abreModalDespesas(param = 'despesasporosplanilha');" class="d-flex justify-content-center" href="#"> <i class="fas fa-sync" ></i>Acessar Outro Período/Conta</a>
...
dataSource.fetch().then(function() {
        ...
        $("#grid").kendoGrid({
            ...
            columns: [
                ...
                { field: "descricaoDespesa", title: "Despesa", filterable: true, width: 300 },
                { field: "razaosocialFornecedor", title: "Fornecedor", filterable: true, width: 200 },
                { field: "precoReal", title: "Custo", filterable: true, width: 150, decimals: 2, aggregates: ["sum"], groupHeaderColumnTemplate: "Total por Grupo: #: kendo.toString(sum, 'c', 'pt-BR') #", footerTemplate: "Total Geral: #: kendo.toString(sum, 'c', 'pt-BR') #", format: '{0:0.00}' },
                { field: "idOS", title: "OS", filterable: true, width: 100 },
                { field: "pago", title: "PG", filterable: true, width: 100 },
                ],
