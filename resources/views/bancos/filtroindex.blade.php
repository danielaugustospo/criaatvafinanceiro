    ...
    <div id="areaTabela">
        <div id="div_BuscaPersonalizada">
            ...
            <div class="group-row">
                ...
                <select class="selecionaComInput form-control col-sm-4 js-example-basic-multiple buscaname" name="nomeBanco" id="nomeBanco">
                    <option value="">Listar todos</option>
                    @foreach ($listaBancos as $bancos)
            ...
            <div class="group-row">
                ...
                <select class="selecionaComInput form-control col-sm-2 js-example-basic-multiple buscaemail" name="codigoBanco" id="codigoBanco">
                    <option value="">Listar todos</option>
                    @foreach ($listaBancos as $bancos)
