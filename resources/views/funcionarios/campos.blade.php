...
<div class="form-group row">
    ...
    <div class="col-sm-2">
        {!! Form::text('cepFuncionario', $valorInput, ['placeholder' => 'CEP', 'class' => 'form-control', 'maxlength' => '8', 'required', 'id' => 'cep','onblur' =>'pesquisacep(this.value)', $variavelReadOnlyNaView]) !!}
    </div>
...
<div class="form-group row ">
    ...
    <div class="col-sm-2">
        {!! Form::number('celularFuncionario', $valorInput, ['placeholder' => 'Celular', 'class' => 'form-control', 'required', 'oninput'=>'javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);','maxlength' => '11', $variavelReadOnlyNaView]) !!}
    </div>
...
<select name="contacorrenteFuncionario" class="selecionaComInput form-control js-example-basic-multiple" {{$variavelDisabledNaView}}>
    @if (Request::path() == 'funcionarios/create')
        <option value="cc">Conta Corrente</option>
        <option value="cp">Conta Poupança</option>
    @else
        <option value="cc" {{ $funcionario->contacorrenteFuncionario == 'cc'?' selected':''}}>Conta Corrente</option>
        <option value="cp" {{ $funcionario->contacorrenteFuncionario == 'cp'?' selected':''}}>Conta Poupança</option>
    @endif
    ...
    <div class="col-sm-4">
        <select class="selecionaComInput form-control" name="bancoFuncionario" {{$variavelDisabledNaView}}>
...
<div class="form-group row">
    ...
    <div class="col-sm-4">
        {!! Form::text('nrcontaFuncionario', $valorInput, ['placeholder' => 'Número Conta', 'class' => 'form-control', 'maxlength' => '11', $variavelReadOnlyNaView]) !!}
    </div>
    <label for="valor2" class="col-sm-2 col-form-label">Agência</label>
    <div class="col-sm-4">
        {!! Form::text('agenciaFuncionario', $valorInput, ['placeholder' => 'Agência', 'class' => 'form-control', 'maxlength' => '11', $variavelReadOnlyNaView]) !!}
    </div>
