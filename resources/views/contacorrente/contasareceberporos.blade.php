...
<script>
    ...
    var dataSource = new kendo.data.DataSource({
        transport: {
            read: {
                url: "{{ route('apicontaareceberporosrelatorio') }}",
                dataType: "json"
            },
        },
    });
    ...
    dataSource.fetch().then(function () {
        ...
        $("#grid").kendoGrid({
            ...
            dataSource: {
                ...
                group: {
                    field: "id", aggregates: [
                        ...
                        { field: "valorareceber", aggregate: "sum" },
            ...
            columns: [
                { field: "id", title: "Nº OS", filterable: true, width: 50 },
                { field: "dataCriacaoOrdemdeServico", title: "Data da OS", filterable: true, width: 100, format: "{0:dd/MM/yyyy}" },
                { field: "eventoOrdemdeServico", title: "Evento", filterable: true, width: 100 },
                
                { field: "valorOrdemdeServico", title: "Valor Projeto", filterable: true, width: 100, decimals: 2, aggregates: ["sum"],  footerTemplate: "Val. Total: #: kendo.toString(sum, 'c', 'pt-BR') #", format: '{0:0.00}' },
                { field: "receitapaga", title: "Valor Recebido", filterable: true, width: 100, decimals: 2,     aggregates: ["sum"],  footerTemplate: "Val. Total: #: kendo.toString(sum, 'c', 'pt-BR') #", format: '{0:0.00}' },
                { field: "valorareceber", title: "Valor a Receber", filterable: true, width: 100, decimals: 2,  aggregates: ["sum"],  footerTemplate: "Val. Total: #: kendo.toString(sum, 'c', 'pt-BR') #", format: '{0:0.00}' },
