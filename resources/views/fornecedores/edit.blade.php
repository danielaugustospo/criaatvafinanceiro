...
<div class="form-group row">
    ...
    <div class="col-sm-4">
        {!! Form::text('nomefavorecidoFornecedor', null, ['placeholder' => 'Preencha este campo', 'class' => 'form-control col-sm-12', 'maxlength' => '100' ]) !!}

        <!-- <input type="text" class="form-control" nome="nomeBanco" id="nomeBanco" placeholder="Nome do Funcionário"> -->
    </div>
    <label for="cpffavorecidoFornecedor" class="col-sm-2 col-form-label">CPF/CNPJ Favorecido Fornecedor</label>
    <div class="col-sm-4">
        {!! Form::number('cpffavorecidoFornecedor', null, ['placeholder' => 'Preencha este campo', 'class' => 'form-control', 'oninput'=>'javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);','maxlength' => '14' ]) !!}
    </div>
