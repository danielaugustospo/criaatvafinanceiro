...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        {!! Form::text('razaosocialCliente', null, ['placeholder' => 'Preencha este campo', 'class' => 'form-control', 'maxlength' => '100']) !!}
...
<div class="form-group row">
    ...
    <div class="col-sm-2">
        {!! Form::number('cepCliente', null, ['placeholder' => 'Preencha este campo', 'class' => 'form-control', 'id' => 'cep', 'onblur' =>'pesquisacep(this.value)', 'oninput'=>'javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);','maxlength' => '8']) !!}

        <!-- <input type="text" class="form-control" nome="nomeBanco" id="nomeBanco" placeholder="Nome do Funcionário"> -->
    </div>
    <label for="enderecoCliente" class="col-sm-1 col-form-label">Endereço</label>
    <div class="col-sm-5">
        {!! Form::text('enderecoCliente', null, ['placeholder' => 'Preencha este campo', 'class' => 'form-control', 'id' => 'endereco', 'maxlength' => '100']) !!}
...
<div class="form-group row">
    ...
    <div class="col-sm-2">
        {!! Form::text('bairroCliente', null, ['placeholder' => 'Preencha este campo', 'class' => 'form-control', 'id' => 'bairro', 'maxlength' => '10']) !!}

        <!-- <input type="text" class="form-control" nome="nomeBanco" id="nomeBanco" placeholder="Nome do Funcionário"> -->
    </div>
    <label for="cidadeCliente" class="col-sm-1 col-form-label">Cidade</label>
    <div class="col-sm-3">
        {!! Form::text('cidadeCliente', null, ['placeholder' => 'Preencha este campo', 'class' => 'form-control', 'id' => 'cidade', 'maxlength' => '100']) !!}

        <!-- <input type="text" class="form-control" nome="nomeBanco" id="nomeBanco" placeholder="Nome do Funcionário"> -->
    </div>
    <label for="estadoCliente" class="col-sm-1 col-form-label">Estado</label>
    <div class="col-sm-1">
        {!! Form::text('estadoCliente', null, ['placeholder' => 'Preencha este campo', 'class' => 'form-control', 'id' => 'uf', 'maxlength' => '100']) !!}
...
<div class="form-group row">
    ...
    <div class="col-sm-2">
        {!! Form::number('telefone1Cliente', null, ['placeholder' => 'Preencha este campo', 'class' => 'form-control', 'oninput'=>'javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);','maxlength' => '11']) !!}

        <!-- <input type="text" class="form-control" nome="nomeBanco" id="nomeBanco" placeholder="Nome do Funcionário"> -->
    </div>
    <label for="telefone2Cliente" class="col-sm-1 col-form-label">2°Tel</label>
    <div class="col-sm-2">
        {!! Form::number('telefone2Cliente', null, ['placeholder' => 'Preencha este campo', 'class' => 'form-control', 'oninput'=>'javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);','maxlength' => '11']) !!}

        <!-- <input type="text" class="form-control" nome="nomeBanco" id="nomeBanco" placeholder="Nome do Funcionário"> -->
    </div>
    <label for="emailCliente" class="col-sm-1 col-form-label">Email</label>
    <div class="col-sm-3">
        {!! Form::email('emailCliente', null, ['placeholder' => 'Preencha este campo', 'class' => 'form-control', 'maxlength' => '100']) !!}
...
<div class="form-group row">
    ...
    <div class="col-sm-2">
        {!! Form::number('cnpjCliente', null, ['placeholder' => 'Preencha este campo', 'class' => 'form-control', 'oninput'=>'javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);','maxlength' => '14']) !!}

        <!-- <input type="text" class="form-control" nome="nomeBanco" id="nomeBanco" placeholder="Nome do Funcionário"> -->
    </div>
    <label for="inscEstadualCliente" class="col-sm-1 col-form-label">Insc. Estadual</label>
    <div class="col-sm-6">
        {!! Form::text('inscEstadualCliente', null, ['placeholder' => 'Preencha este campo', 'class' => 'form-control', 'maxlength' => '20']) !!}
...
<div class="form-group row">
    ...
    <div class="col-sm-2">
        {!! Form::number('cpfCliente', null, ['placeholder' => 'Preencha este campo', 'class' => 'form-control', 'oninput'=>'javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);','maxlength' => '11']) !!}

        <!-- <input type="text" class="form-control" nome="nomeBanco" id="nomeBanco" placeholder="Nome do Funcionário"> -->
    </div>
    <label for="identidadeCliente" class="col-sm-1 col-form-label">RG</label>
    <div class="col-sm-3">
        {!! Form::number('identidadeCliente', null, ['placeholder' => 'Preencha este campo', 'class' => 'form-control', 'oninput'=>'javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);','maxlength' => '10']) !!}
        <!-- <input type="text" class="form-control" nome="nomeBanco" id="nomeBanco" placeholder="Nome do Funcionário"> -->
    </div>
    <label for="dataCadastroCliente" class="col-sm-1 col-form-label">Data de Contrato</label>
    <div class="col-sm-2">
        {!! Form::text('dataCadastroCliente', null, ['placeholder' => 'Data Contrato', 'class' => 'form-control', 'maxlength' => '8']) !!}
...
<div class="form-group row">
    ...
    <div class="col-sm-2">
        {!! Form::text('contatoCliente', null, ['placeholder' => 'Contato', 'class' => 'form-control', 'maxlength' => '8']) !!}
        <!-- <input type="text" class="form-control" id="enderecoFuncionario" placeholder="Endereço"> -->
    </div>
    <label for="siteCliente" class="col-sm-1 col-form-label">Site</label>
    <div class="col-sm-6">
        {!! Form::text('siteCliente', null, ['placeholder' => 'Site', 'class' => 'form-control', 'maxlength' => '8']) !!}
        <!-- <input type="text" class="form-control" id="enderecoFuncionario" placeholder="Endereço"> -->
    </div>
...
<div class="form-group row">
    ...
    <div class="col-sm-3">
        <!-- {!! Form::text('bancoCliente', null, ['placeholder' => 'Preencha este campo', 'class' => 'form-control', 'maxlength' => '10']) !!} -->
    ...
    <div class="col-sm-2">
        {!! Form::text('agenciaCliente', null, ['placeholder' => 'Preencha este campo', 'class' => 'form-control', 'maxlength' => '10']) !!}

        <!-- <input type="text" class="form-control" nome="nomeBanco" id="nomeBanco" placeholder="Nome do Funcionário"> -->
    </div>
    <label for="nrcontaCliente" class="col-sm-2 col-form-label">Número Conta Cliente</label>
    <div class="col-sm-3">
        {!! Form::text('nrcontaCliente', null, ['placeholder' => 'Preencha este campo', 'class' => 'form-control', 'maxlength' => '10']) !!}
