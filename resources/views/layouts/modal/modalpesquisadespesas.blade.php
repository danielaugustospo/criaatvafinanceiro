                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="row ml-2 mr-2 mt-1">
                                ...
                                <input class="form-control col-sm-5" type="date" value="{{date('d-m-Y')}}" name="dtinicio" id="dtinicio">
                                <input class="form-control col-sm-5" type="date" value="{{date('t-m-Y')}}" name="dtfim" id="dtfim">
                            </div>
                            <div class="row ml-2 mr-2">
