...
<div class="form-group row" style="box-shadow: 25px 2px 25px 1px; padding-top: 20px; padding-bottom: 20px;">
    ...
    <div class="pl-2 pr-2" id="telaGeral">
                        ...
                        @isset($despesa)
                            @if ($despesa->despesaCodigoDespesas == $listaCodigoDespesas->id)
                                <option value="{{ $listaCodigoDespesas->id }}" selected>
                                    {{ $listaCodigoDespesas->despesaCodigoDespesa }} |
                                    {{ $listaCodigoDespesas->grupoDespesa }}
                                </option>
                            @endif
                        @endisset
        ...
        <div class="form-group row" id="telaQuantidade">
            ...
            <div class="col-sm-2">
                {!! Form::text('quantidadeSemParcelamento', $valorInput, [
            ...
            <div class="col-sm-2">
                {!! Form::text('valorUnitarioSemParcelamento', $valorInput, [
                    'placeholder' => 'Preencha este campo',
