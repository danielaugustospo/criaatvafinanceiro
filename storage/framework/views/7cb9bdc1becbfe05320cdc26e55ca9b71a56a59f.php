...
<div class="row">
    <div class="col-lg-12 margin-tb">
        ...
        <div class="d-flex justify-content-between pull-right">
            ...
            <a class="btn btn-success ml-3" href="<?php echo e(route('ordemdeservicos.create')); ?>"> Cadastrar OS</a>
            <?php endif; ?>
...
<?php echo $__env->make('ordemdeservicos/filtroindex', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script type="text/javascript">
    ...
    var table = $('.data-table').DataTable({
        ...
        ajax: {
            url: "<?php echo e(route('tabelaOrdemServicos')); ?>",
            data: function(d) {
                d.id = $('.buscaId').val(),
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/clients/client2/web4/web/resources/views/ordemdeservicos/index.blade.php ENDPATH**/ ?>