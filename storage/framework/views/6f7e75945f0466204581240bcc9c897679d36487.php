  ...
  <div class="modal fade bd-example-modal-lg modalreceita" tabindex="-1" role="dialog"
      aria-labelledby="myLargeModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg">
          <div class="modal-content">
              
              <form action="<?php echo e(route('displayreceita')); ?>" id="formFiltraReceita" method="get">
                  <?php echo csrf_field(); ?>
                  <div class="row">
                      <div class="col-sm-12">
                          <div class="modal-header">
                              <label for="">Selecione a receita</label>
                              ...
                              <div class="col-8 col-sm-6">
                                  <div class="modal-body">
                                      ...
                                      <div class="row ml-2 mr-2">
                                          ...
                                          <input class="form-control" list="datalistOrdemServico" id="ordemservico" name="ordemservico" placeholder="Digite ou selecione...">
...
<?php /**PATH /var/www/clients/client2/web4/web/resources/views/layouts/modal/modalpesquisareceita.blade.php ENDPATH**/ ?>