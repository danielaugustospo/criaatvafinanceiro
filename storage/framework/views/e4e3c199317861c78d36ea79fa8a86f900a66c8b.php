...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2 class="text-center">Consulta de <?php echo e($titulo); ?></h2>
...

                        {
                            command: [{
                                ...
                                click: function(e) {
                                    ...
                                    window.location.href = "<?php echo env('APP_URL'); ?>" + "/despesas/" +
                                        data.id;
                                }
                            }],
                            width: 90,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/clients/client2/web4/web/resources/views/despesas/index.blade.php ENDPATH**/ ?>