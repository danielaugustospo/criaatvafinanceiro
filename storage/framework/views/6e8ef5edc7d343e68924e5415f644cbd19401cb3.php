        ...
        <div class="col-lg-12 margin-tb">
            ...
            <div class="d-flex justify-content-between pull-right">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('fornecedor-create')): ?>
                    <a class="btn btn-success" href="<?php echo e(route('fornecedores.create')); ?>">Cadastrar Fornecedor</a>
                <?php endif; ?>
                    ...
                    },
                    {
                            command: [{
                                ...
                                click: function(e) {
                                    ...
                                    window.location.href = "<?php echo env('APP_URL'); ?>" + "/fornecedores/" + data.id;
                                }
                            }],
                            width: 70,
                            exportable: false,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/clients/client2/web4/web/resources/views/fornecedores/index.blade.php ENDPATH**/ ?>