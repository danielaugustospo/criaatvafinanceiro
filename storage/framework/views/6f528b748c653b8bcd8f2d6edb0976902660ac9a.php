...
<div class="row">
    <div class="col-lg-12 margin-tb">
        ...
        <div class="d-flex justify-content-between pull-right">
            ...
            <a class="btn btn-success" href="<?php echo e(route('funcionarios.create')); ?>">Cadastrar Funcionário</a>
            <?php endif; ?>
            <?php echo $__env->make('layouts/exibeFiltro', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
</div>
...
<hr>
<?php echo $__env->make('funcionarios/filtroindex', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
var table = $('.data-table').DataTable({
    ...
    ajax: {
        url: "<?php echo e(route('funcionarios.index')); ?>",
        data: function(d) {
            d.id                    = $('#id').val(),
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/clients/client2/web4/web/resources/views/funcionarios/index.blade.php ENDPATH**/ ?>