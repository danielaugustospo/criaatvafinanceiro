...
$('body').on('click', '.recarregaMateriais', function() {
    ...
    const url = "<?php echo e(route('listaMateriais')); ?>";
...
function recarregaCodigoDespesa() {
    ...
    const url = "<?php echo e(route('listaCodigoDespesa')); ?>";
...
function recarregaFornecedorDespesa() {
    ...
    const url = "<?php echo e(route('listaFornecedores')); ?>";
...
function recarregaReembolsadoDespesa() {
    ...
    $('#reembolsado').select2();
}<?php /**PATH /var/www/clients/client2/web4/web/resources/views/despesas/formulario/manipulacoescorpo.blade.php ENDPATH**/ ?>