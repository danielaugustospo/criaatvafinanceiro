...
<div class="form-group row">
    ...
    <div class="col-sm-6">
        <?php echo Form::date('dataCriacaoOrdemdeServico', $dataInicio, [
...
<div class="form-group row">
        ...
        <select name="idClienteOrdemdeServico" id="idClienteOrdemdeServico" class="selecionaComInput form-control">
            ...
            <?php $__currentLoopData = $cliente; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clientes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($clientes->id); ?>"
                    <?php if(isset($ordemdeservico)): ?> <?php if($ordemdeservico->idClienteOrdemdeServico == $clientes->id): ?> selected <?php endif; ?> <?php endif; ?>><?php echo e($clientes->razaosocialCliente); ?></option>
    ...
    <div class="col-sm-2">
        <?php echo Form::text('valorOrdemdeServico', $valorInput, [
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <?php echo Form::text('eventoOrdemdeServico', $valorInput, [
            'placeholder' => 'Preencha este campo',
            'class' => 'form-control',
            'maxlength' => '100',
            'required',
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <?php echo Form::text('obsOrdemdeServico', $valorInput, [
            'placeholder' => 'Preencha este campo',
            'class' => 'form-control',
            'maxlength' => '100',
        ]); ?>
...
<div class="form-group row ml-2">
    ...
    <input type="radio" class="mt-3" name="fatorR" id="fatorR" value="0"
        <?php if(isset($ordemdeservico->fatorR) && $ordemdeservico->fatorR == '0'): ?> checked <?php endif; ?>>
    ...
    <input type="radio" class="mt-3" name="fatorR" id="fatorR" value="1"
        <?php if(isset($ordemdeservico->fatorR) && $ordemdeservico->fatorR == '1'): ?> checked <?php endif; ?>>
    <label for="obsOrdemdeServico" class="col-sm-1 mt-3 pl-0 col-form-label">Sim</label>

</div>


<?php echo Form::hidden('ehcompra', '0', [
    'placeholder' => 'Preencha este campo',
    'class' => 'form-control',
    'maxlength' => '100',
]); ?>
...
<?php echo Form::hidden('idOS', 'null', [
    'placeholder' => 'Id OS ',
    'class' => 'form-control',
    'maxlength' => '1',
    'id' => 'idOS',
...
<?php echo Form::hidden('excluidoDespesa', '0', [
...
<table class="styled-table rwd-table" id="tabelaPagamento">
    ...
    <tbody id="habilita_receita" class="habilita_receita">
        ...
        <?php if(Route::currentRouteName() === 'ordemdeservicos.create'): ?>
            <?php echo $__env->make('ordemdeservicos/trcreate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php else: ?>
...
<?php echo Form::hidden('registroreceita', '0', [
    'placeholder' => 'Preencha este campo',
...
<?php echo Form::hidden('idosreceita', 'null', [
...
<?php echo Form::hidden('dataOrdemdeServico', '00-00-0000', [
    'placeholder' => 'Preencha este campo',
    'class' => 'form-control',
    'maxlength' => '100',
]); ?>
...
<?php echo Form::hidden('servicoOrdemdeServico', 'Campo Serviço', [
    'placeholder' => 'Preencha este campo',
    'class' => 'form-control',
    'maxlength' => '100',
]); ?>
...
<?php echo Form::hidden('dataExclusaoOrdemdeServico', '00', [
...
<?php echo Form::hidden('ativoOrdemdeServico', '1', [
    'placeholder' => 'Ativo',
    'class' => 'form-control',
    'maxlength' => '1',
...
<?php echo Form::hidden('excluidoOrdemdeServico', '0', [
    'placeholder' => 'Excluído',
    'class' => 'form-control',
    'maxlength' => '1',
...
<?php echo $__env->make('ordemdeservicos.estilo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/clients/client2/web4/web/resources/views/ordemdeservicos/campos.blade.php ENDPATH**/ ?>